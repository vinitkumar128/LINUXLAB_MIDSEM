...
### Name: vinit kumar, Roll No.: 590029353 , Date: 2025-10-18
...
if [ -f "$LOG_FILE" ]; then
    mail -s "Daily System Log - $(date +%Y-%m-%d)" vinitkumar_vk@outlook.com < "$LOG_FILE"
    echo "Log emailed to local mailbox: vinitkumar_vk@outlook.com"
else
...
<p align="center">
<img src="img/img-1.png" width="900">
</p>
...
```bash
crontab -e
0 8 * * * /c/users/HP/onedrive/desktop/linux/midsem_assignment.sh
```
...
<p align="center">
<img src="img/img-3.png" width="900">
</p>
